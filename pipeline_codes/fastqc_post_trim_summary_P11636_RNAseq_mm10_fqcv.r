rm(list=ls()) 
outFile='P11636_RNAseq_mm10.countInFastQcVis.Result'
parSampleFile1=''
parSampleFile2=''
parSampleFile3=''
parFile1='/nobackup/h_vivian_weiss_lab/20240801_11636_RNAseq_mouse/fastqc_raw_summary/result/P11636_RNAseq_mm10.FastQC.reads.tsv'
parFile2='/nobackup/h_vivian_weiss_lab/20240801_11636_RNAseq_mouse/fastqc_post_trim_summary/result/P11636_RNAseq_mm10.FastQC.reads.tsv'
parFile3=''


setwd('/nobackup/h_vivian_weiss_lab/20240801_11636_RNAseq_mouse/fastqc_post_trim_summary/result')
